...
export default async function HomePage({params}: {params: Promise<{locale: Locale}>}) {
  ...
  return <div className="home-page">
    ...
    <section id="story" className="story-band"><div className="section-shell story-grid"><div className="story-monogram" aria-hidden="true">C<span>&</span>A</div><div className="story-copy-block"><h2>{t('storyTitle')}</h2>{['storyText','storyText2','storyText3','storyText4'].map((key) => <p key={key}>{t(key)}</p>)}</div></div></section>
