...
const entries: Array<Omit<Product, 'priceCents' | 'currency' | 'stock' | 'editionTotal' | 'editionNumber' | 'available'>> = [
  {
    ...
    image: '/images/products/cesky-krumlov.jpg', orientation: 'portrait',
    localized: {
  ...
  },
  {
    ...
    image: '/images/products/ceske-budejovice.jpg', orientation: 'portrait',
    localized: {
  ...
  },
  {
    ...
    image: '/images/products/beroun.jpg', orientation: 'portrait',
    localized: {
  ...
  },
  {
    ...
    image: '/images/products/prague.jpg', orientation: 'portrait',
    localized: {
  ...
  },
  {
    ...
    image: '/images/products/tabor.jpg', orientation: 'portrait',
    localized: {
  ...
  },
  {
    ...
    image: '/images/products/czech-republic.jpg', orientation: 'portrait',
    localized: {
  ...
  },
  {
    ...
    image: '/images/products/pardubice.jpg', orientation: 'portrait',
    localized: {
  ...
  },
  {
    ...
    image: '/images/products/kutna-hora.jpg', orientation: 'landscape',
    localized: {
      en: {city: 'Kutná Hora', title: 'Kutná Hora — Copper Plate Impression', short: 'Silver miners and royal symbols shaped by hand.', story: 'Kutná Hora rose from medieval silver and rivalled Prague in wealth and influence. Its churches and mines hold the gravity of labour transformed into beauty.', heraldry: 'Mining tools, royal emblems and the central chalice record the source of the city’s historic prosperity.', alt: 'Landscape copper plate impression of the Kutná Hora mining coat of arms'},
      zh: {city: '库特纳霍拉', title: '库特纳霍拉｜城市纹章铜板拓印', short: '银矿工人与王家符号，在手工锤击中成形。', story: '库特纳霍拉因中世纪银矿而兴盛，财富和影响力一度与布拉格相望。教堂与矿井共同保留了劳动转化为美的重量。', heraldry: '采矿工具、王家徽记和中央圣杯，记录着城市历史繁荣的来源。', alt: '库特纳霍拉矿业城市纹章横向手工铜板拓印作品'}
    }
  },
  {
    slug: 'hradec-kralove', sku: 'COA-CZ-HK-009', region: 'bohemia',
    image: '/images/products/hradec-kralove.jpg', orientation: 'portrait',
    localized: {
